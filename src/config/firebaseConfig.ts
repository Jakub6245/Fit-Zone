...
export const dbChatUsersListCollection = collection(db, "chatUserList");
...
export const dbExercisesCollection = collection(db, "exercises");
export const dbTrainingCollection = collection(db, "training");
export const dbSavedTrainingCollection = collection(db, "savedTraining");
